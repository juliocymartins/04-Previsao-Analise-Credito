...
- analise_risco_credito_extra.ipynb: Arquivo do Jupyter Notebook contendo nosso projeto completo com algumas técnica diferentes (WoE no lugar de One-Hot-Encoding e utilização de K-Fold para validação).
